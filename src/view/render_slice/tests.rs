...
fn scroll_horizontal_with_segments() {
	...
	render_slice.sync_view_data(&view_data);
	assert_rendered(&render_slice, &["{BODY}", "{Normal}123"]);
	render_slice.record_scroll_right();
	render_slice.sync_view_data(&view_data);
	assert_rendered(&render_slice, &["{BODY}", "{Normal}234"]);
	render_slice.record_scroll_right();
	render_slice.sync_view_data(&view_data);
	assert_rendered(&render_slice, &["{BODY}", "{Normal}345"]);
	render_slice.record_scroll_right();
	render_slice.sync_view_data(&view_data);
	assert_rendered(&render_slice, &["{BODY}", "{Normal}456"]);
	render_slice.record_scroll_right();
	render_slice.sync_view_data(&view_data);
	assert_rendered(&render_slice, &["{BODY}", "{Normal}567"]);
	render_slice.record_scroll_right();
	render_slice.sync_view_data(&view_data);
	assert_rendered(&render_slice, &["{BODY}", "{Normal}678"]);
	render_slice.record_scroll_right();
	render_slice.sync_view_data(&view_data);
	...
	render_slice.record_scroll_right();
	render_slice.sync_view_data(&view_data);
	assert_rendered(&render_slice, &["{BODY}", "{Normal}90a"]);
	render_slice.record_scroll_right();
	render_slice.sync_view_data(&view_data);
	assert_rendered(&render_slice, &["{BODY}", "{Normal}0ab"]);
	render_slice.record_scroll_right();
	render_slice.sync_view_data(&view_data);
